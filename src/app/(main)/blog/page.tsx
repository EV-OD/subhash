...
export const metadata: Metadata = {
  title: 'Blog',
  description: 'Read our latest articles on home care, aging, and well-being.',
};
              ...
              <Card key={post.slug} className="flex flex-col">
                ...
                <div className="flex flex-col flex-1">
                  <CardHeader>
                    ...
                    <CardDescription>
                      {post.entry.date && new Date(post.entry.date).toLocaleString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                      })}
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-muted-foreground line-clamp-2">{post.entry.excerpt}</p>
                  </CardContent>
