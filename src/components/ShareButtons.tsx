...
export default function ShareButtons({ title, url, minimal = false, className }: ShareButtonsProps) {
  ...
  return (
    <div className={cn("flex flex-col gap-4 py-6 border-t border-b border-border my-8", className)}>
